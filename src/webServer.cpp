...
{	
	...
	for( auto ind : a.vRanges)
	{
		...
		RANGE_HOLDER += "\t\t<div><span class='textLabel " + mWaves[ind].name+"-name' id='" + mWaves[ind].name + "-name'>" + mWaves[ind].name + ": </span><span class='textLabel " + mWaves[ind].name+"-value' id=''> 0</span>\n";
